...
class OutsiderDiscussionSection extends StatelessWidget {
  const OutsiderDiscussionSection({super.key});
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16.0),
              Text(
                'As DivMeds is in the MVP development process, this feature is currently not available. Help us in reaching more healthcare peers to make DivMeds even better!',
